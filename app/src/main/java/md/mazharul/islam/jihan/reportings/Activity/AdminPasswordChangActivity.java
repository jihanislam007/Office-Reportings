    ...
    private void changePassword() {
        ...
        client.post(ServerInfo.BASE_URL+"AdminPasswordChange/",params,new JsonHttpResponseHandler(){
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                try {
                    if(response.getBoolean("res")){
                        Toast.makeText(AdminPasswordChangActivity.this, "Successfully change password", Toast.LENGTH_SHORT).show();
                    }else{
                        Toast.makeText(AdminPasswordChangActivity.this, "User Name Or Password Does not match in admin account", Toast.LENGTH_SHORT).show();
                    }
                    getResult=true;
                } catch (Exception e) {
                    e.printStackTrace();
            ...
            public void onPostProcessResponse(ResponseHandlerInterface instance, HttpResponse response) {
                if(!getResult){
                    Toast.makeText(AdminPasswordChangActivity.this, "User Name Is InValid", Toast.LENGTH_SHORT).show();
                }
                getResult=false;
            }
        });
